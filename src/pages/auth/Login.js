              ...
              <div className="w-80 h-100 rounded-lg border-2 border-gray-300 shadow-xl flex flex-col " >
                  ...
                  <form onSubmit={handleSubmit} className="mt-2" >
                      ...
                      <div className="ml-5 mr-5 relative">
                          <label htmlfor="email-l" className= "absolute px-1 font-semibold bg-white left-3 z-20 text-blue-600 text-xs  " > Email ID </label>
                          <input 
                              type="text" 
                              id="email-l" 
                      ...
                      <div className="mt-14 ml-5 mr-5 relative">
                          <label htmlfor="password-l" className= "absolute px-1 font-semibold bg-white left-3 z-20 text-blue-600 text-xs  " > Password </label>
                          <input 
                              type="password" 
                              id="password-l" 
                              className=" absolute top-2 z-10 w-30 rounded-md border-0 py-1.5 pl-3 w-full  text-gray-900 ring-1 ring-inset ring-gray-300 focus:ring-inset    "/>
                      ...
                      <div className="mt-28 ml-5 flex justify-between items-center mr-5">
                          ...
                          <button 
                              type="submit" 
                              className="inline-block w-16 h-10 bg-blue-500 text-white font-semibold rounded-md hover:bg-blue-600"
                          >
                              Login
                          </button>
                      </div>
