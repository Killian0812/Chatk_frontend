        ...
        <div className="h-screen w-screen flex bg-white">
            ...
            <div className="h-full w-1/2 flex items-center justify-center">
                ...
                <div className="w-80 h-70 rounded-lg border-2 border-gray-300 shadow-xl flex flex-col " >
                    ...
                    {/* Title */}
                    <div className="mt-1 text-sm w-[100%] text-black px-5">
                    ...
                    <div className="mt-2" >
                        ...
                        <div className="ml-5 mr-5 relative">
                            <label htmlFor="email" className="absolute px-1 font-semibold bg-white left-3 z-20 text-blue-600 text-xs  " > Email ID </label>
                            <Tippy
                                hideOnClick="false"
                                placement="left"
                                trigger="focus"
